...
export default function Profile() {
    ...
    //                 {imageError ? (<span className="text-red-700 ">error upload (file must be less than 2mb)</span>) : imagePercent > 0 &&
    //                     imagePercent < 100 ? (
    ...
    return (
      ...
      request.resource.contentType.matches('image/.*') */}
            ...
            <p className='text-green-700 mt-5'>{updateSuccess && 'update'}</p>
        </div>
    );
